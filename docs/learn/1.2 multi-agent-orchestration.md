...
> **Exam Trap — Blaming downstream subagents for coverage gaps when the coordinator's task decomposition was too narrow**
>
...
> **Exam Trap — Assuming subagents share memory or inherit the coordinator's conversation history**
>
...
> **Exam Trap — Proposing direct inter-subagent communication as an efficiency improvement**
>
...
> **Exam Trap — Adding more subagents to fix a decomposition problem**
>
...
**Option A** — The web search subagent used queries that were too narrow, missing results for other energy types

**Option B** — The synthesis subagent failed to identify gaps in the research and request additional coverage

**Option C** — The coordinator decomposed the topic into only solar and wind subtopics, never assigning geothermal, tidal, biomass, or fusion to any subagent

**Option D** — The document analysis subagent did not have access to sources covering other renewable energy types

## Sources

- [Claude Agent SDK Overview](https://platform.claude.com/docs/en/agent-sdk/overview) — Anthropic
- [Multi-Agent Research System Scenario (Skilljar)](https://anthropic.skilljar.com/claude-with-the-anthropic-api) — Anthropic
